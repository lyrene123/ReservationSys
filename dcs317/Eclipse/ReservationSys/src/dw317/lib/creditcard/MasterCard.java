...
/**
 * The MasterCard class is a final implementation class that extends
 * from the AbstractCreditCard class. As a specific creditcard class,
 * the MasterCard class inherits the general data and behavior of a
...
public final class MasterCard extends AbstractCreditCard  {
	...
	/**
	 * The MasterCard constructor calls the super constructor and sets 
	 * the MasterCard instance's credit card type and validated
	 * number 
	 * @param number The MasterCard number of type String
			...
			throws IllegalArgumentException
	{
		...
		if(number==null || number==""){
			throw new IllegalArgumentException("A credit card of type "
					+ "MasterCard must"
					+ " exists with 16 digits only");
		}
		
		String trimmedNum = number.trim(); //trim any spaces contained 
		//in the number
		...
		return trimmedNum;//return validated credit number
