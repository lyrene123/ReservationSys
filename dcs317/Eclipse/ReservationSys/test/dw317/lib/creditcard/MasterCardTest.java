...
public class MasterCardTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(sameCard.getClass() + " " + testCard.getClass());
		...
		// test case 8 - card number is empty
		try {
			testCard = new MasterCard("");
		} catch (IllegalArgumentException e) {
			System.out.println("test case 8 - empty: " + e.getMessage());
		}

		// test case 9 - card number is null
		try {
			testCard = new MasterCard(null);
		} catch (IllegalArgumentException e) {
			System.out.println("test case 9 - null: " + e.getMessage());
		}
