...
public class ListUtilitiesTest {
	...
	public static void testSortArrays() {
		...
		testSortArrays("Case 4: A valid Double Array with full capacity", emailList, true);
		ListUtilitiesTest.<Boolean>
		testSortArrays("Case 5: A valid Boolean Array with full capacity", bol, true);
		ListUtilitiesTest.<Integer>
		testSortArrays("Case 6: Empty String", values2, false);
	}
	...
	/*
	 * private static void printArray(int[] anArray) { for (int i = 0; i <
	 * anArray.length; i++) { if (i > 0) { System.out.print(","); }
